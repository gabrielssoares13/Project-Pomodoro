      ...
      <Card className="mx-auto w-full max-w-md shadow-2xl">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="rounded-lg bg-muted p-4 text-sm">
            <h3 className="font-semibold mb-2">Como usar a técnica Pomodoro:</h3>
            <ol className="list-decimal pl-5 space-y-1">
              <li>Escolha uma tarefa para focar</li>
              <li>Configure o temporizador para 25 minutos</li>
              <li>Trabalhe até o alarme tocar</li>
              <li>Faça uma pausa curta (5 minutos)</li>
              <li>A cada 4 sessões, faça uma pausa longa (15 minutos)</li>
            </ol>
          </div>
        </CardContent>
      </Card>
